...
##########################################################################
# Default: Build iGame with standard optimizations and 020 support
##########################################################################
all: iGame
...
CFLAGS		= -c -mcpu=68020 -Os -fomit-frame-pointer -std=c99 -DCPU_VERS=68020 -DRELEASE_DATE=$(DATE)
...
include make_includes/obj_020.inc

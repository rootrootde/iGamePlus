...
static genresList *genresListTail = NULL;
...
void sortGenresList(void)
{
	...
	genresListTail = sorted;
	if (genresListTail != NULL)
	{
		while (genresListTail->next != NULL)
			genresListTail = genresListTail->next;
	}
}
